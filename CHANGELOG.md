...
- `stl/v2.0-petg/corpo150_petg.stl`: coroa turbo idêntica à v1.0 (80 fendas × 3 mm,
  ...
  (z −9 a −4,8; r 64,5 → 68,7). Sem o chanfro do furo da saia.
- `stl/v2.0-petg/cesto150_v5.stl`: borda a 45° que assenta no anel (batente positivo,
  autocentrante, não trava); topo em z −3 (nada acima da borda do cano);
...
- Verificação: 1 corpo cada, 0 colisões em 0/+20/+50 mm, assento com 0,6 mm
  de acomodação, perímetro aberto 52% → 240 mm de vertedouro equivalente.
